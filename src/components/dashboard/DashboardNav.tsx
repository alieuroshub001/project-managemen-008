...
export default function DashboardNav({ role }: DashboardNavProps) {
  ...
  const baseLinks: NavLink[] = [
    { href: '/dashboard', name: 'Overview', icon: Home },
  ];
  ...
  const roleLinks: Record<UserRole, NavLink[]> = {
    ...
    hr: [
      ...
      { href: '/dashboard/hr/directory', name: 'Employee Directory', icon: Users },
      { href: '/dashboard/hr/attendance', name: 'Leave & Attendance', icon: Calendar },
    ...
    client: [
      ...
      { href: '/dashboard/projects/progress', name: 'Project Progress', icon: TrendingUp },
      { href: '/dashboard/communication/client', name: 'Communication', icon: MessageSquare },
      { href: '/dashboard/reporting/client', name: 'Project Reports', icon: BarChart3 },
      { href: '/dashboard/time-tracking/view', name: 'Time Reports', icon: Eye },
    ],
  };
        ...
        `}>
          ...
          <div className={`transition-all duration-300 ${isCollapsed ? 'pt-2' : 'pt-6'}`}>
            ...
            >
              ...
              <div className="h-px bg-gradient-to-r from-blue-200/50 via-indigo-200/50 to-transparent mx-3"></div>
            </div>
