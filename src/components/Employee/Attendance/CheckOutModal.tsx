...
export default function CheckOutModal({ visible, onCancel, onSuccess }: CheckOutModalProps) {
  ...
  const addTask = () => {
    ...
    const toAdd: Task = {
      ...
      hoursSpent: Number.isFinite(Number(newTask.hoursSpent)) && Number(newTask.hoursSpent) > 0
  ...
  return (
    ...
    >
      <Form form={form} onFinish={handleSubmit} layout="vertical">
        ...
        <Form.Item 
          name="reason" 
          label="Reason for early check-out (if applicable)"
        >
        ...
        <div className="border rounded-lg p-4 bg-blue-50 border-blue-200">
          <Title level={5} className="mb-3">Add New Task</Title>
          ...
          <div className="mt-2 text-xs text-gray-600">
            <strong>Tip:</strong> Include hours spent to track your productivity accurately. 
        ...
        <Form.Item>
          <div className="flex justify-end space-x-2">
            ...
            <Button 
              ...
              disabled={
                tasks.length === 0 || 
                (useLocation && !location && !locationLoading)
              }
