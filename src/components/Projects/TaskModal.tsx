...
import { X, User, Clock, ChevronRight, AlertCircle, CheckCircle, Pause, Calendar, MessageSquare, Paperclip, Edit, Trash2 } from 'lucide-react';
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setTask({...task, actualHours: e.target.value ? parseFloat(e.target.value) : 0})}
                  placeholder="0"
                  min="0"
                  step="0.5"
                />
            ...
            <>
              <div className="flex justify-between items-start">
                ...
                <div className="flex space-x-2">
                  {(session?.user.id === task.createdBy._id || session?.user.role === 'superadmin') && (
                    <>
                      <button
