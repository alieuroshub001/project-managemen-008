...
// lib/auth.ts - Fixed OTP functions
...
export async function createOTPRecord(
  ...
  await OTP.findOneAndUpdate(
    ...
    { 
      ...
      referenceEmail: referenceEmail || email // Store original user email as reference
    },
...
export async function verifyOTP(
  ...
  // (for cases where OTP was sent to admin but verification is with user email)
  if (!record) {
